              ...
              child:
                ...
                builder: (context, state) {
                  if (state is BeasiswaNonApproveLoading) {
                    ...
                    var filteredData = state.beasiswaNon.where((beasiswaNon) {
                      final beasiswaNonName = beasiswaNon.nama ?? '';
                      final matchesSearch = beasiswaNonName
                          .toLowerCase()
                          .contains(_searchText.toLowerCase());
                      final matchesProdi = _selectedProdiId == null ||
                          beasiswaNon.idProdi == _selectedProdiId;
                      ...
                      children: [
                        ...
                        Expanded(
                          child: filteredData.isEmpty
                              ...
                              : ListView(
                                  children:
                                      filteredData.map((beasiswaNonMethod) {
                                    final id =
                                        '${beasiswaNonMethod.approvalKey}';
