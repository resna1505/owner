  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            // Tab Non Approve dengan filter prodi dan select all
            BlocProvider(
              ...
              child: BlocBuilder<KrsNonApproveBloc, KrsNonApproveState>(
                builder: (context, state) {
                  if (state is KrsNonApproveLoading) {
                    ...
                    var filteredData = state.krs.where((krsNon) {
                      final krsNonName = krsNon.nama ?? '';
                      final matchesSearch = krsNonName
                          .toLowerCase()
                          .contains(_searchText.toLowerCase());

                      // Asumsikan KRS model memiliki field idProdi, sesuaikan dengan struktur model Anda
                      final matchesProdi = _selectedProdiId == null ||
                          krsNon.idProdi ==
                              _selectedProdiId; // Sesuaikan field ini dengan model KRS Anda
            ...
            // Tab Approve dengan filter prodi
            BlocProvider(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: filteredData.isEmpty
                              ...
                              : ListView(
                                  children:
                                      filteredData.map((krsApproveMethod) {
